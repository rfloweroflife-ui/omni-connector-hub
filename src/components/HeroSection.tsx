...
import { ArrowRight, Sparkles, Play, Zap, Shield, Volume2 } from "lucide-react";
...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 spore-pattern opacity-25" />
      ...
      <div className="absolute bottom-1/4 left-1/3 w-40 h-40 bg-spore-gold/15 rounded-full blur-[60px] float" style={{ animationDelay: '-4s' }} />
      ...
      <div className="container max-w-6xl mx-auto relative z-10 px-4 py-20">
        <div className="text-center">
          ...
          <Badge 
            variant="outline" 
            className="mb-8 border-accent/60 bg-accent/10 backdrop-blur-md text-accent px-6 py-2.5 text-sm animate-fade-in shadow-lg shadow-accent/20"
          >
            <Sparkles className="w-4 h-4 mr-2 animate-pulse" />
            AI-Powered Mycology Platform · Voice Enabled
          </Badge>
          ...
          <div className="glass-card max-w-3xl mx-auto p-8 mb-12 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <p className="text-xl md:text-2xl text-foreground/90 leading-relaxed">
              Your complete mycology companion. From first inoculation to expert cultivation, 
              <span className="text-accent font-medium"> guided by AI</span>, 
              <span className="text-primary font-medium"> powered by voice</span>, and backed by 
              <span className="text-spore-gold font-medium"> live research</span>.
            </p>
          </div>
          ...
          {/* Feature pills */}
          <div className="flex flex-wrap gap-3 justify-center mt-10 animate-fade-in" style={{ animationDelay: '0.35s' }}>
            <div className="flex items-center gap-2 bg-card/60 backdrop-blur-sm border border-border/30 rounded-full px-4 py-2 text-sm text-muted-foreground">
              <Volume2 className="w-4 h-4 text-accent" />
              ElevenLabs Voice
            </div>
            <div className="flex items-center gap-2 bg-card/60 backdrop-blur-sm border border-border/30 rounded-full px-4 py-2 text-sm text-muted-foreground">
              <Zap className="w-4 h-4 text-spore-gold" />
              Perplexity Search
            </div>
            <div className="flex items-center gap-2 bg-card/60 backdrop-blur-sm border border-border/30 rounded-full px-4 py-2 text-sm text-muted-foreground">
          ...
          <div className="grid grid-cols-3 gap-6 mt-16 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <div className="glass-card p-6 group hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-accent/20">
            ...
            <div className="glass-card p-6 group hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-primary/20">
            ...
            <div className="glass-card p-6 group hover:scale-105 transition-all duration-300 hover:shadow-lg hover:shadow-spore-gold/20">
              <div className="text-4xl md:text-5xl font-display font-bold text-spore-gold">24/7</div>
              <div className="text-sm text-muted-foreground mt-1">AI + Voice Support</div>
            </div>
          </div>
        </div>
      </div>
